...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2025 at 03:41 AM
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `message_color`, `role`) VALUES
(42, 'bibliotekarz@gmail.com', 'bibliotekarz', '$2y$10$LSRaUPJAF3LPQKXT57KAJO3ZdoIIwQQ7AfpMvWsPOgR2cAIGPpX.2', '#73475c', 1),
(43, 'admin@admin.com', 'admin', '$2y$10$2HYivHXJWzQMRduo/wb93Ojz6ku9RMy8p2gGis/n8RMlo9KCW95qe', '#44cb73', 2);
...
(18, 42, '2025-02-11', '2025-02-11 21:46:36', 1),
(19, 43, '2025-02-11', '2025-02-11 21:46:42', 1);
...
('root', '[{\"db\":\"login_db\",\"table\":\"users\"},{\"db\":\"login_db\",\"table\":\"borrowed_books\"},{\"db\":\"login_db\",\"table\":\"messages\"},{\"db\":\"login_db\",\"table\":\"user_activity\"}]');
...
('root', 'login_db', 'users', '{\"sorted_col\":\"`password` DESC\"}', '2025-02-11 21:40:34');
...
('root', '2025-02-12 01:18:11', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
